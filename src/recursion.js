...
var sum = function(array) {
    ...
    if (array.length === 2) {
        ...
        return array[n] + sum(array.slice(n + 1));
        };
    }
};
...
var exponent = function(base, exp) {
  ...
  if (exp === 0) {
      ...
      if (exp < 0) {
          return 1 / exponent(base, -(exp - 1)) * (base); 
      } else {
...
var reverse = function(string) {
    if (string.length === 0) {
      ...
      return string[1] + string[0]; 
        ...
        var popped = string.slice(0, -1); 
        return (string[string.length - 1]) + reverse(popped); 
    }
};
...
var palindrome = function(string) {
    ...
    var noSpace = /\s/g;
    var result = lower.replace(noSpace, 'p'); 
    ...
    if (result.length === 0) {
      ...
      return true;  
    } else if (result.length === 3 && result[0] === result[2]) {
        return true;
    } else {
